...
export default function LoginPage() {
  ...
  return (
    <AuthPageLayout
      ...
      heroTitle="Nexora AI"
      heroSubtitle={'AI-powered learning designed for every mind.\nAdaptive, accessible, and intelligent.'}
      features={['ADHD Focus Mode', 'Autism Support', 'Dyslexia Aid']}
      featureStyle="pills"
      footer={
    ...
    >
      <form onSubmit={submit}>
        <CardContent className="space-y-5 px-8">
          ...
          {/* Submit */}
          <Button type="submit" className="w-full h-12 text-base font-semibold bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-700 hover:to-emerald-700 shadow-lg shadow-teal-500/25 transition-all hover:shadow-xl hover:shadow-teal-500/30" disabled={isLoading}>
            {isLoading ? (
          ...
          <div className="grid grid-cols-2 gap-2">
            {[
              { label: '👤 Admin', e: 'admin@nexora.ai', p: 'admin123456' },
