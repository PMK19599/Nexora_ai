...
(async () => {
  try {
    ...
    const admin = await User.create({ name: 'Admin User', email: 'admin@nexora.ai', password: 'admin123456', role: 'admin', learningTrack: 'normal', neurodivergentType: 'none', skills: ['Management'] });
    ...
    console.log('\n✅ Seed completed!');
    console.log('Admin:  admin@nexora.ai / admin123456');
    ...
    process.exit(0);
  } catch (e: any) { console.error('[SeedService] Failed to seed database:', e.message || e); process.exit(1); }
})();
