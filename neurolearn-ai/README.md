# 🧠 NeuroLearn AI — AI-Powered E-Learning Platform
...
- The default URI `mongodb://127.0.0.1:27017/neurolearn` will work automatically
...
3. Edit `backend/.env` and set:
   ```
   MONGODB_URI=mongodb+srv://youruser:yourpass@cluster.mongodb.net/neurolearn
   ```
